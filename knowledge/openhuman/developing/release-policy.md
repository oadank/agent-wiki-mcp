...
5. Complete the [[..docs/RELEASE-MANUAL-SMOKE|manual smoke checklist]], then paste the completed sign-off block (verbatim, with every checked item left checked) into the release PR description before tagging.
