...
* [[native-tools/README|Native Tools]]. most heavy tool output flows through TokenJuice.
* [[obsidian-wiki/memory-tree|Memory Tree]]. the downstream consumer of compressed output.
