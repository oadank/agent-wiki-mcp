...
> **TL;DR** Custom API Server (Custom Format)
...
- For calling an openai-compatible endpoint, [[openai_compatible|go here]]
- For modifying incoming/outgoing calls on proxy, [[.proxy/call_hooks|go here]]
