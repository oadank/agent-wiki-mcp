...
tags: []
sources:
  - ./knowledge/openclaw/claude-code-docs/_llms.txt
sourceType: article
certainty: fact
status: active
created: "2026-05-22T17:51:30.965401+00:00"
updated: "2026-05-22T17:51:30.965449+00:00"
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
- [Week 16 · April 13–17, 2026](https://code.claude.com/docs/en/whats-new/2026-w16.md): Claude Opus 4.7 with the new xhigh effort level, Routines on Claude Code on the web, /ultrareview cloud code review, a /usage breakdown that shows what's driving your limits, and native binaries replacing the bundled JavaScript.
