...
sources:
  - /opt/openclaw/data/workspace/skills/agent-wiki-mcp/README.md
...
```bash
# 1. 克隆
git clone https://github.com/oadank/agent-wiki-mcp.git
cd agent-wiki-mcp
...
| [agent-wiki-mcp 项目 README](https://github.com/oadank/agent-wiki-mcp) | 1 | 本项目自身文档 |
