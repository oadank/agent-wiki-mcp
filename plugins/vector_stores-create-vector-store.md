...
> **TL;DR** /vector_stores - Create Vector Store
...
| Support LLM Providers (Dataset Management) | [[/docs/providers/ragflow_vector_store|**RAGFlow**]] | Dataset creation and management (search not supported) |
