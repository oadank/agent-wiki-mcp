...
tags: []
sources:
  - ./mcp_server/node_modules/jose/README.md
sourceType: document
certainty: fact
status: active
created: "2026-05-22T17:50:16.322873+00:00"
updated: "2026-05-22T17:50:16.322910+00:00"
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
- [[docs/jwt/verify/functions/jwtVerify|JWT Claims Set Validation & Signature Verification]] using the `jwtVerify` function
  - [[docs/jwks/remote/functions/createRemoteJWKSet|Using a remote JSON Web Key Set (JWKS)]]
  - [[docs/jwks/local/functions/createLocalJWKSet|Using a local JSON Web Key Set (JWKS)]]
- [[docs/jwt/sign/classes/SignJWT|Signing]] using the `SignJWT` class
- Utility functions
  - [[docs/util/decode_protected_header/functions/decodeProtectedHeader|Decoding Token's Protected Header]]
  - [[docs/util/decode_jwt/functions/decodeJwt|Decoding JWT Claims Set]] prior to its validation

### Encrypted JSON Web Tokens

The `jose` module supports encrypted JSON Web Tokens and provides functionality for encrypting and decrypting tokens, as well as their JWT Claims Set validation.

- [[docs/jwt/decrypt/functions/jwtDecrypt|Decryption & JWT Claims Set Validation]] using the `jwtDecrypt` function
- [[docs/jwt/encrypt/classes/EncryptJWT|Encryption]] using the `EncryptJWT` class
- Utility functions
  - [[docs/util/decode_protected_header/functions/decodeProtectedHeader|Decoding Token's Protected Header]]
...
- Key Import Functions
  - [[docs/key/import/functions/importJWK|JWK Import]]
  - [[docs/key/import/functions/importSPKI|Public Key Import (SPKI)]]
  - [[docs/key/import/functions/importX509|Public Key Import (X.509 Certificate)]]
  - [[docs/key/import/functions/importPKCS8|Private Key Import (PKCS #8)]]
- Key and Secret Generation Functions
  - [[docs/key/generate_key_pair/functions/generateKeyPair|Asymmetric Key Pair Generation]]
  - [[docs/key/generate_secret/functions/generateSecret|Symmetric Secret Generation]]
- Key Export Functions
  - [[docs/key/export/functions/exportJWK|JWK Export]]
  - [[docs/key/export/functions/exportPKCS8|Private Key Export]]
  - [[docs/key/export/functions/exportSPKI|Public Key Export]]

### JSON Web Signature (JWS)

The `jose` module supports signing and verification of JWS messages with arbitrary payloads in Compact, Flattened JSON, and General JSON serialization syntaxes.

- Signing - [[docs/jws/compact/sign/classes/CompactSign|Compact]], [[docs/jws/flattened/sign/classes/FlattenedSign|Flattened JSON]], [[docs/jws/general/sign/classes/GeneralSign|General JSON]]
- Verification - [[docs/jws/compact/verify/functions/compactVerify|Compact]], [[docs/jws/flattened/verify/functions/flattenedVerify|Flattened JSON]], [[docs/jws/general/verify/functions/generalVerify|General JSON]]
  - [[docs/jwks/remote/functions/createRemoteJWKSet|Using a remote JSON Web Key Set (JWKS)]]
  - [[docs/jwks/local/functions/createLocalJWKSet|Using a local JSON Web Key Set (JWKS)]]
- Utility functions
  - [[docs/util/decode_protected_header/functions/decodeProtectedHeader|Decoding Token's Protected Header]]
...
- Encryption - [[docs/jwe/compact/encrypt/classes/CompactEncrypt|Compact]], [[docs/jwe/flattened/encrypt/classes/FlattenedEncrypt|Flattened JSON]], [[docs/jwe/general/encrypt/classes/GeneralEncrypt|General JSON]]
- Decryption - [[docs/jwe/compact/decrypt/functions/compactDecrypt|Compact]], [[docs/jwe/flattened/decrypt/functions/flattenedDecrypt|Flattened JSON]], [[docs/jwe/general/decrypt/functions/generalDecrypt|General JSON]]
- Utility functions
  - [[docs/util/decode_protected_header/functions/decodeProtectedHeader|Decoding Token's Protected Header]]
...
- [[docs/jwk/thumbprint/functions/calculateJwkThumbprint|Calculating JWK Thumbprint]]
- [[docs/jwk/thumbprint/functions/calculateJwkThumbprintUri|Calculating JWK Thumbprint URI]]
- [[docs/jwk/embedded/functions/EmbeddedJWK|Verification using a JWK Embedded in a JWS Header]]
- [[docs/jwt/unsecured/classes/UnsecuredJWT|Unsecured JWT]]
- [[docs/util/errors/README|JOSE Errors]]
